...
// [ADO] ked stlacis naraz 3 klavesy, tak sa nestane nic ?? pripadne vsetky kontroly dat do osobitnej metody napr isMovingUp(){
//    if(keys['ArrowUp'] === true && keys['ArrowRight'] === false && keys['ArrowLeft'] === false && keys['ArrowDown'] === false){
//      return true;
//    }
//    return false;
//}
// a potom by bola kontrola len if(isMovingUp){player.animation("up");} --> prehladnejsie
function keyControl(){
...
//[ADO] tu by som dal skor ten nazov hasCollision, a ono to hlada asi 2 objekty ktore sa nejako stretnu, avsak hlada list...co sa stane v pripade, ak je viac
//objektov na sebe ?? potom pouzivas len jeden index stale nizsie v metode 
...
function hasCollisions() {
    ...
    //[ADO] hasCollisions je nevystizny nazov, skor checkCollisions, nasledne premenna hasColission bude asi index niecoho, tiez je nazov blby celkom
    //taktiez rozdelit na podmetody...bude ze checkCollisions a v nej sa budu volat metody checkEnemyColission, checkItemsCollisions, checkShootsCollision
    //je to prehladnejsie potom
    ...
    if (hasCollision > -1){ 
        ...
        //TODO[ADO] - staci dat gameBar.w = 300 ak to je max, netreba davat 300 - aktualna velkost
